...
public sealed class CursosRepository : ICursosRepository
{
    ...
    public CursosRepository(SqlConnectionFactory factory) => _factory = factory;
    ...
    public async Task<CursoDetalleDto?> GetByIdAsync(int idCurso, CancellationToken ct = default)
    {
        ...
        // Obtener datos del curso (usando consulta directa porque los SPs existentes no devuelven Idinstructor como int)
